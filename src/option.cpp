...
int draw_option()
{
    ...
    else if (CheckCollisionPointRec(R_mousePoint, pattern3_rect))
    {
        if (IsMouseButtonReleased(MOUSE_BUTTON_LEFT))
        {
            return 13;
    ...
    else if (CheckCollisionPointRec(R_mousePoint, pattern4_rect))
    {
        if (IsMouseButtonReleased(MOUSE_BUTTON_LEFT))
        {
            return 14;
    ...
    else if (CheckCollisionPointRec(R_mousePoint, pattern5_rect))
    {
        if (IsMouseButtonReleased(MOUSE_BUTTON_LEFT))
        {
            return 15;
