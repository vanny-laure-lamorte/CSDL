...
// rect_btn1.x+40, rect_btn1.y+320, rect_btn1.width-85, rect_btn1.height-250
...
// Button 2
    else if (CheckCollisionPointRec(mousePoint, rect_btn2))    {
    ...
    // Button 3
    else if (CheckCollisionPointRec(mousePoint, rect_btn3))    {
